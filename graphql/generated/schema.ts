...
export function getSdk<C>(requester: Requester<C>) {
  return {
    ...
    NodeByPath(variables: NodeByPathQueryVariables, options?: C): Promise<NodeByPathQuery> {
      return requester<NodeByPathQuery, NodeByPathQueryVariables>(NodeByPathDocument, variables, options);
    },
