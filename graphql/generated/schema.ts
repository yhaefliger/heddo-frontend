...
export type ConfigPagesSettings = ConfigPages &
  Entity & {
...
export type CropFocalPoint = Crop &
  Entity &
  EntityRevisionable & {
...
export type ParagraphContainerSimple = Entity &
  EntityOwnable &
  EntityPublishable &
  EntityRevisionable &
  Paragraph & {
...
export type ParagraphGallery = Entity &
  EntityOwnable &
  EntityPublishable &
  EntityRevisionable &
  Paragraph & {
...
export type ParagraphTitleText = Entity &
  EntityOwnable &
  EntityPublishable &
  EntityRevisionable &
  Paragraph & {
...
export type ConfigPageSettingsFieldsFragment = {
  __typename?: 'ConfigPagesSettings'
  header?: {
    __typename?: 'FieldConfigPagesSettingsFieldDefaultHeader'
    entity?: {
...
export type NodeByPathQueryVariables = Exact<{
  path: Scalars['String']
}>

export type NodeByPathQuery = {
  __typename?: 'Query'
  route?:
    | { __typename?: 'DefaultInternalUrl' }
    | {
...
`
export const NodeByPathDocument = gql`
...
export function getSdk<C>(requester: Requester<C>) {
  return {
    ConfigPage(
      variables: ConfigPageQueryVariables,
      options?: C
    ): Promise<ConfigPageQuery> {
      return requester<ConfigPageQuery, ConfigPageQueryVariables>(
        ConfigPageDocument,
        variables,
        options
      )
    ...
    Menu(variables: MenuQueryVariables, options?: C): Promise<MenuQuery> {
      return requester<MenuQuery, MenuQueryVariables>(
        MenuDocument,
        variables,
        options
      )
    ...
    NodeByPath(
      variables: NodeByPathQueryVariables,
      options?: C
    ): Promise<NodeByPathQuery> {
      return requester<NodeByPathQuery, NodeByPathQueryVariables>(
        NodeByPathDocument,
        variables,
        options
      )
    ...
    Paths(variables?: PathsQueryVariables, options?: C): Promise<PathsQuery> {
      return requester<PathsQuery, PathsQueryVariables>(
        PathsDocument,
        variables,
        options
      )
